...
public class Constants {
    public static final String TITLE = "Here is a really long ass title that is for even better testing. You can't test unless your title is so long that it scrolls off of the window. There is still some space left so here is a little more.";
