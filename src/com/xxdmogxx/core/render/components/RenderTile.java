...
public class RenderTile {
    ...
    public RenderTile() {
        float[] vertices = Utils.readObjVertices("src/com/xxdmogxx/resources/hexagon.obj", false);
        int[] indices = Utils.readObjIndices("src/com/xxdmogxx/resources/hexagon.obj");
